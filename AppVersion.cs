namespace ElsEvo
{
    ...
    ///   - Numero: versão "bonita" exibida na janela Sobre (ex.: "1.1").
    ...
    ///     "1.1" e "1.1.0" NÃO são consideradas iguais pelo Version.TryParse (o primeiro
    ...
    public static class AppVersion
    {
        ...
        public const string Numero = "1.1";

        public const string VersaoParaAtualizacao = "1.1.0";
    }
}
