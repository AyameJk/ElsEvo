...
namespace ElsEvo
{
    public partial class GerenciarModsWindow : Window
    {
        ...
        // Abre o Windows Explorer já selecionando o arquivo do mod (se uma linha da tabela
        // estiver selecionada) ou a pasta do pack (fallback pelo combo do topo). Portado
        // do canal beta.
        ...
        // Compacta a pasta inteira do pack selecionado num .zip escolhido pelo usuário
        // (SaveFileDialog). Portado do canal beta.
